<template>
  <div class="content">
    <div class="content__left">
      <p class="text">Для тех, кто хочет изучать язык в комфортном для себя режиме и в удобное время. Программа корректируется под индивидуальные запросы ученика.</p>
