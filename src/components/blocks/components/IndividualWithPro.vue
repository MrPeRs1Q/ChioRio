<template>
  <div class="content">
    ...
    <div class="content__right">
      <img v-if="windowSizeForMobile > 800" src="@/assets/images/block5/individual-with-pro.svg" alt="mini-group">
      <img v-else src="@/assets/images/block5/individual-with-pro-mobile.svg" alt="mini-group">
    </div>
  </div>
