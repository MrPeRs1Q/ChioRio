<template>
  <div class="content">
    <div class="content__left">
      <p class="text">Обучение в мини-группе позволяет держать хороший темп в изучении языка, глубоко разбирать материал, получить максимум внимания от преподавателя.</p>
    ...
    <div class="content__right">
      <img v-if="windowSizeForMobile > 800" src="@/assets/images/block5/mini-group.png" alt="mini-group">
      <img v-else src="@/assets/images/block5/mini-group-mobile.png" alt="mini-group">
    </div>
  </div>
